(ns cell-console.views.carnaval
  (:require
     ...
     [:> Step {:key "step_2"}
        ...
        [:> StepContent
           [:> Paper {:class (.-paper classes)}
            [:> List
             [:> ListItem
              [:> Typography {:component "h6" :variant "h6"} "IHM.Libby.gamma.PDX - Libby.HighCPUUtilization"]]
             [:> ListItem
              [:> Typography {:component "h6" :variant "h6"} "IHM.Libby.prod.PDX - Libby.HighCPUUtilization"]]
             [:> ListItem
              [:> Typography {:component "h6" :variant "h6"} "	IHM.Libby.janeProd.PDX - Libby.HighCPUUtilization"]]]]
           [:> Button {:variant "contained"
                       :color "primary"
                       :disabled false
   ...
   [:div {:class (.-heroHeader classes) :style {::backgroundColor "#0e2b621f" :height "250px"}}
    [:> Container {:maxWidth "sm"}
     [:> Typography {:component "h3" :variant "h3" :align "center"
      ...
      "Cleanup Carnaval Monitors Across Cells"]]]
